...
namespace API.Persistence
{
    public class DbInitializer
    {
            ...
            IConfiguration configuration)
        {
            ...
            {
                await roleManager.CreateAsync(new AppIdentityRole { Name = "Medico", Activo = true, Descripcion = "Rol de m�dico", Value = "medico", TipoRol = TipoRoles.Medico });
            }
            ...
            if (!await context.Grupos.AnyAsync()) 
            {
                var grupos = new List<Grupo>
                {
                    ...
                    new Grupo
                    {
                        ...
                        Nombre = "ATNREG",
                        Descr = "Grupo de Usuarios tipo Atenci�n y Registro",
                        Activo = true,
                        FechaCreacion = DateTime.UtcNow,
                        FechaUltimaActualizacion = DateTime.UtcNow
                    },
            ...
            if (!context.Corporaciones.Any())
            {
                var corporaciones = new List<Corporacion>
                {
                    new Corporacion
                    {
                        ...
                        Nombre = "Loma",
                        Descripcion = "Corporaci�n la Loma",
                    },
                    new Corporacion
                    {
                        Id = Guid.NewGuid().ToString(),
                        Nombre = "Santa Rosa",
                        Descripcion = "Corporaci�n Santa Rosa",
                    }
                    ,
                    new Corporacion
                    {
            ...
            if (!context.EntidadFederativas.Any())
            {
                var entidades = new List<EntidadFederativa>
                {
                    ...
                    new EntidadFederativa { Id = 9, Nombre = "CIUDAD DE M�XICO", Abreviacion = "DF" },
                    ...
                    new EntidadFederativa { Id = 15, Nombre = "M�XICO", Abreviacion = "MC" },
                    new EntidadFederativa { Id = 16, Nombre = "MICHOAC�N", Abreviacion = "MN" },
                    new EntidadFederativa { Id = 17, Nombre = "MORELOS", Abreviacion = "MS" },
                    new EntidadFederativa { Id = 18, Nombre = "NAYARIT", Abreviacion = "NT" },
                    new EntidadFederativa { Id = 19, Nombre = "NUEVO LE�N", Abreviacion = "NL" },
                    new EntidadFederativa { Id = 20, Nombre = "OAXACA", Abreviacion = "OC" },
                    new EntidadFederativa { Id = 21, Nombre = "PUEBLA", Abreviacion = "PL" },
                    new EntidadFederativa { Id = 22, Nombre = "QUER�TARO", Abreviacion = "QT" },
                    new EntidadFederativa { Id = 23, Nombre = "QUINTANA ROO", Abreviacion = "QR" },
                    new EntidadFederativa { Id = 24, Nombre = "SAN LUIS POTOS�", Abreviacion = "SP" },
                    ...
                    new EntidadFederativa { Id = 31, Nombre = "YUCAT�N", Abreviacion = "YN" },
            ...
            if (!context.Sistemas.Any())
            {
                var sistemas = new List<Sistema>
                {
                    new Sistema
                    {
                        ...
                        Descripcion = "Sistema para la gesti�n administrativa",
                        Activo = true
                    },
                    new Sistema
                    {
                        Id = 2,
                        Nombre = "Sistema Cl�nico",
                        Descripcion = "Sistema para la gesti�n cl�nica",
                        Activo = true
                    },
                    new Sistema
                    {
                        ...
                        Descripcion = "Sistema para la gesti�n de aspirantes a causar alta en los CUSAEM",
                        Activo = true
                    },
            ...
            if (!context.BasesDatos.Any())
            {
                ...
                var basesDatos = new List<BaseDatos>
                {
                    ...
                    new BaseDatos
                    {
                        ...
                        Descripcion = "Base de datos para el sistema cl�nico",
            ...
            var estadosCiviles = new List<EstadoCivil>
            {
                ...
                new EstadoCivil
                {
                    Id = 5,
                    Nombre = "Uni�n Libre",
                    Descripcion = "Persona en uni�n libre",
                    Activo = true,
                    FechaCreacion = DateTime.UtcNow,
                    FechaUltimaActualizacion = DateTime.UtcNow
                },
            ...
            if (!context.NivelesEducativos.Any())
            {
                var nivelesEducativos = new List<NivelEducativo>
                {
                    ...
                    new NivelEducativo
                    {
                        Id = 1,
                        Nombre = "Primaria",
                        Descripcion = "Educaci�n primaria",
                        Activo = true,
                        FechaCreacion = DateTime.UtcNow,
                        FechaUltimaActualizacion = DateTime.UtcNow
                    },
                    new NivelEducativo
                    {
                        Id = 2,
                        Nombre = "Secundaria",
                        Descripcion = "Educaci�n secundaria",
                        Activo = true,
                        FechaCreacion = DateTime.UtcNow,
                        FechaUltimaActualizacion = DateTime.UtcNow
                    },
                    new NivelEducativo
                    {
                        Id = 3,
                        Nombre = "Preparatoria",
                        Descripcion = "Educaci�n preparatoria o bachillerato",
                        Activo = true,
                        FechaCreacion = DateTime.UtcNow,
                        FechaUltimaActualizacion = DateTime.UtcNow
                    },
                    new NivelEducativo
                    {
                        Id = 4,
                        Nombre = "Licenciatura",
                        Descripcion = "Educaci�n universitaria de licenciatura",
                        Activo = true,
                        FechaCreacion = DateTime.UtcNow,
                        FechaUltimaActualizacion = DateTime.UtcNow
                    },
                    new NivelEducativo
                    {
                        Id = 5,
                        Nombre = "Maestr�a",
                        Descripcion = "Posgrado de maestr�a",
                        Activo = true,
                        FechaCreacion = DateTime.UtcNow,
                        FechaUltimaActualizacion = DateTime.UtcNow
                    },
           ...
           if (!context.Procesos.Any())
           {
               ...
               // Obtener los IDs de los procesos padres reci�n insertados
               ...
               // FASE 2: Insertar procesos HIJOS (con ProcesoPadreId v�lidos)
